...
from albums.views import create_song, show_albums, create_album, show_songs, show_song_detail
from . import views
...
urlpatterns = [
    ...
    path('songs/delete/<int:song_id>/', views.delete_downloaded_song, name='delete_song'),
]